...
const CRM_NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    heading: 'Workspace',
    items: [
      { id: 'wynta-ai',  label: 'Wynta AI',         icon: 'sparkles'     },
    ...
    <aside className="crm-sidebar">
      ...
      <div className="crm-mobile-cta">
        ...
        <div className="crm-mobile-cta__badges">
          <a className="crm-app-badge" href="#" aria-label="Download on the App Store">
          ...
          <a className="crm-app-badge" href="#" aria-label="Get it on Google Play">
      ...
      <div className="crm-nav-cta">
        <button className="crm-btn-upgrade" type="button">
