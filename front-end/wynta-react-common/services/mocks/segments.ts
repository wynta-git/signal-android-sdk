...
export const SEGMENT_FIELDS = [
  { id: 'kyc_status',       label: 'KYC status',            type: 'enum'    as const, options: ['VERIFIED','PENDING','REJECTED','NOT_STARTED'] },
  { id: 'account_status',   label: 'Account status',        type: 'enum'    as const, options: ['ACTIVE','SUSPENDED','CLOSED','BANNED'] },
  { id: 'tier',             label: 'Loyalty tier',          type: 'enum'    as const, options: ['Bronze','Silver','Gold','VIP T1','VIP T2','VIP T3'] },
  { id: 'country',          label: 'Country',               type: 'enum'    as const, options: ['India','Nepal','Bangladesh','Sri Lanka'] },
  { id: 'state',            label: 'State',                 type: 'enum'    as const, options: ['Maharashtra','Karnataka','Gujarat','Tamil Nadu','Delhi','Telangana','West Bengal','Punjab','Rajasthan','Kerala','Uttar Pradesh'] },
  { id: 'registered',       label: 'Registered',            type: 'recency' as const },
  { id: 'last_login',       label: 'Last login',            type: 'recency' as const },
  { id: 'last_bet',         label: 'Last bet placed',       type: 'recency' as const },
  { id: 'last_deposit',     label: 'Last deposit',          type: 'recency' as const },
  { id: 'first_dep_status', label: 'First-deposit status',  type: 'enum'    as const, options: ['MADE','PENDING'] },
  { id: 'lifetime_dep',     label: 'Lifetime deposits (₹)', type: 'amount'  as const },
  { id: 'lifetime_wager',   label: 'Lifetime wagered (₹)',  type: 'amount'  as const },
  { id: 'lifetime_ggr',     label: 'Lifetime GGR (₹)',      type: 'amount'  as const },
  { id: 'dep_count_30',     label: 'Deposits (last 30d)',   type: 'number'  as const },
  { id: 'sessions_7',       label: 'Sessions (last 7d)',    type: 'number'  as const },
  { id: 'product',          label: 'Played product',        type: 'enum'    as const, options: ['Rummy','Poker','Casino','Sports','Fantasy'] },
  { id: 'birthday_month',   label: 'Birthday month',        type: 'enum'    as const, options: ['Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec'] },
  { id: 'bonus_received',   label: 'Bonus received',        type: 'recency' as const },
  { id: 'referral_source',  label: 'Referral source',       type: 'enum'    as const, options: ['Organic','Friend referral','Paid social','Affiliate','SEM'] },
];
