...
export const DEFAULT_CONNECTORS: Connector[] = [
  ...
  { id: 'fcm',        name: 'Firebase FCM',      category: 'Notifications',  categoryDescription: 'Connect notification channels for push, email and messaging', icon: 'bell',           iconBg: '#fef3c7', status: 'disconnected',                         description: 'Push notifications for iOS and Android apps' },
