...
const CHAT_URL = process.env.NEXT_PUBLIC_CHAT_URL || 'https://qa-chat.fozilpartners.com/chat/';
...
export default function ChatPage() {
  ...
  useEffect(() => {
    ...
    iframeRef.current?.contentWindow?.postMessage({ type: 'AUTH_TOKEN', token }, CHAT_ORIGIN);
  }, [token, chatReady]);
