...
export default function LifecycleBar({ usage, size = 'lg' }: LifecycleBarProps) {
  ...
  const segs = LIFECYCLE_STATES.map((state: string) => {
    const amt = parseFloat(String(usage.states[state].amount)) || 0;
