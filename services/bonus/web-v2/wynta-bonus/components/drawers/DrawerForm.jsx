...
export default function DrawerForm({ state, submitting, onCancel, onSubmit }) {
  switch (state.type) {
    ...
    case 'ISSUE_CODE_BONUS': return <IssueCodeBonusForm state={state} submitting={submitting} onCancel={onCancel} onSubmit={onSubmit}/>;
    default: return null;
  }
}
