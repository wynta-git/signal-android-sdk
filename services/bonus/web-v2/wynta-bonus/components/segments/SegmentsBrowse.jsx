...
export default function SegmentsBrowse({ list, search, setSearch, sortBy, setSortBy, onCreate, onPick }) {
  return (
    <>
      <div className="modal-toolbar">
        ...
        <div className="seg-sort">
          ...
          <div className="seg" style={{ '--cols': 3, padding: 3 }}>
      ...
      <div className="modal-footer-row">
        <span className="modal-footer-meta">{list.length} of {MANUAL_SEGMENTS.length} segments</span>
      </div>
    </>
  );
}
