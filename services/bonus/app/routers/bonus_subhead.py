...
async def create_bonus_subhead(payload: BonusSubheadCreate) -> BonusSubheadResponse:
    """
...
async def patch_bonus_subhead(subhead_id: int, payload: BonusSubheadUpdate) -> BonusSubheadResponse:
    """
...
async def put_bonus_subhead_owners(
    subhead_id: int, payload: OwnersUpsertRequest
) -> list[OwnerEntry]:
    """
...
async def put_bonus_subhead_limits(
    subhead_id: int, payload: LimitsUpsertRequest
) -> list[BudgetPeriod]:
    """
