...
-- COLUMN GROUPS
-- ─────────────
-- Identity        : id, subhead_id, configuration_id, site_id, name, description
-- Bonus mechanics : bonus_type, release_mode, product,
--                   start_date, end_date, wager_multiplier, no_of_chunks,
--                   release_bucket, ingame_consumption_pct,
--                   chunk_expiry_days, bonus_expiry_days,
--                   wager_chip_type, credit_chip_type
-- JSON config     : bonus_config, cashback_config, specification_config,
--                   login_config, schedule_config, x_wagering_config, messages
...
INSERT INTO `bonus_configure`
    (`id`, `subhead_id`, `configuration_id`, `site_id`, `name`, `description`,
     `bonus_type`, `release_mode`, `product`,
     `start_date`, `end_date`,
     `wager_multiplier`, `no_of_chunks`, `release_bucket`,
     `ingame_consumption_pct`, `chunk_expiry_days`, `bonus_expiry_days`,
     `wager_chip_type`, `credit_chip_type`,
     `bonus_config`, `cashback_config`, `specification_config`,
     `login_config`, `schedule_config`, `x_wagering_config`, `messages`,
